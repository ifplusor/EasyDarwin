...
QTSS_Error QTSSCallbacks::QTSS_AddStaticAttribute(QTSS_ObjectType inObjectType, const char *inAttrName, void *inUnused,
...
QTSS_Error QTSSCallbacks::QTSS_AddInstanceAttribute(QTSS_Object inObject, const char *inAttrName, void *inUnused,
                                                    QTSS_AttrDataType inAttrDataType)
{
    Assert(inUnused == NULL);
    ...
    return ((QTSSDictionary *) inObject)->AddInstanceAttribute(inAttrName, NULL, inAttrDataType,
...
QTSS_Error QTSSCallbacks::QTSS_GetAttrInfoByID(QTSS_Object inObject, QTSS_AttributeID inAttrID,
...
QTSS_Error QTSSCallbacks::QTSS_GetAttrInfoByName(QTSS_Object inObject, const char *inAttrName,
                                                 QTSS_Object *outAttrInfoObject)
{
    if (inObject == NULL)
        return QTSS_BadArgument;
...
QTSS_Error QTSSCallbacks::QTSS_GetValuePtr(QTSS_Object inDictionary, QTSS_AttributeID inID, UInt32 inIndex,
...
QTSS_Error QTSSCallbacks::QTSS_GetValue(QTSS_Object inDictionary, QTSS_AttributeID inID, UInt32 inIndex, void *ioBuffer,
                                        UInt32 *ioLen)
{
...
QTSS_Error QTSSCallbacks::QTSS_GetValueAsString(QTSS_Object inDictionary, QTSS_AttributeID inID, UInt32 inIndex,
                                                char **outString)
{
    if (inDictionary == NULL)
        return QTSS_BadArgument;
...
QTSS_Error QTSSCallbacks::QTSS_StringToValue(char *inValueAsString, const QTSS_AttrDataType inType, void *ioBuffer,
                                             UInt32 *ioBufSize)
{
    return QTSSDataConverter::StringToValue(inValueAsString, inType, ioBuffer, ioBufSize);
}

QTSS_Error QTSSCallbacks::QTSS_ValueToString(void *inValue, const UInt32 inValueLen, const QTSS_AttrDataType inType,
                                             char **outString)
{
...
QTSS_Error QTSSCallbacks::QTSS_SetValue(QTSS_Object inDictionary, QTSS_AttributeID inID, UInt32 inIndex,
...
QTSS_Error QTSSCallbacks::QTSS_SetValuePtr(QTSS_Object inDictionary, QTSS_AttributeID inID, const void *inBuffer,
                                           UInt32 inLen)
{
                                            ...
                                            UInt32 *outIndex, QTSS_Object *outCreatedObject)
{
    ...
    return ((QTSSDictionary *) inDictionary)->CreateObjectValue(inID, outIndex, (QTSSDictionary **) outCreatedObject,
                                                                theMap);
}
...
QTSS_Error QTSSCallbacks::QTSS_Write(QTSS_StreamRef inStream, void *inBuffer, UInt32 inLen, UInt32 *outLenWritten,
                                     UInt32 inFlags)
{
    if (inStream == NULL)
        return QTSS_BadArgument;
...
QTSS_Error QTSSCallbacks::QTSS_WriteV(QTSS_StreamRef inStream, iovec *inVec, UInt32 inNumVectors, UInt32 inTotalLength,
...
QTSS_Error QTSSCallbacks::QTSS_AddService(const char *inServiceName, QTSS_ServiceFunctionPtr inFunctionPtr)
{
    ...
    return QTSSDictionaryMap::GetMap(QTSSDictionaryMap::kServiceDictIndex)->
            AddAttribute(inServiceName, (QTSS_AttrFunctionPtr) inFunctionPtr, qtssAttrDataTypeUnknown,
                         qtssAttrModeRead);
}
...
QTSS_Error QTSSCallbacks::QTSS_AddRTPStream(QTSS_ClientSessionObject inClientSession,
                                            QTSS_RTSPRequestObject inRTSPRequest, QTSS_RTPStreamObject *outStream,
                                            QTSS_AddStreamFlags inFlags)
{
    if ((inClientSession == NULL) || (inRTSPRequest == NULL) || (outStream == NULL))
        return QTSS_BadArgument;
    return ((RTPSession *) inClientSession)->AddStream((RTSPRequestInterface *) inRTSPRequest, (RTPStream **) outStream,
                                                       inFlags);
}

QTSS_Error QTSSCallbacks::QTSS_Play(QTSS_ClientSessionObject inClientSession, QTSS_RTSPRequestObject inRTSPRequest,
...
QTSS_Error QTSSCallbacks::QTSS_Authenticate(const char *inAuthUserName, const char *inAuthResourceLocalPath,
                                            const char *inAuthMoviesDir, QTSS_ActionFlags inAuthRequestAction,
                                            QTSS_AuthScheme inAuthScheme, QTSS_RTSPRequestObject ioAuthRequestObject)
{
    if ((inAuthUserName == NULL) || (inAuthResourceLocalPath == NULL) || (inAuthMoviesDir == NULL) ||
    ...
    (void) request->SetValue(qtssRTSPReqUserName, 0, inAuthUserName, ::strlen(inAuthUserName),
                             QTSSDictionary::kDontObeyReadOnly);
    (void) request->SetValue(qtssRTSPReqLocalPath, 0, inAuthResourceLocalPath, ::strlen(inAuthResourceLocalPath),
                             QTSSDictionary::kDontObeyReadOnly);
    (void) request->SetValue(qtssRTSPReqRootDir, 0, inAuthMoviesDir, ::strlen(inAuthMoviesDir),
                             QTSSDictionary::kNoFlags);
    (void) request->SetValue(qtssRTSPReqAction, 0, (const void *) &inAuthRequestAction, sizeof(QTSS_ActionFlags),
                             QTSSDictionary::kNoFlags);
    (void) request->SetValue(qtssRTSPReqAuthScheme, 0, (const void *) &inAuthScheme, sizeof(QTSS_AuthScheme),
                             QTSSDictionary::kDontObeyReadOnly);
    QTSSUserProfile *profile = request->GetUserProfile();
    (void) profile->SetValue(qtssUserName, 0, inAuthUserName, ::strlen(inAuthUserName),
                             QTSSDictionary::kDontObeyReadOnly);
...
QTSS_Error QTSSCallbacks::QTSS_Authorize(QTSS_RTSPRequestObject inAuthRequestObject, char **outAuthRealm,
