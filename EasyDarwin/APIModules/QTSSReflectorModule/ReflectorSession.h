...
public:
	...
	{ return fSourceInfo->GetNumStreams(); }

	SourceInfo *GetSourceInfo()
	{ return fSourceInfo; }

	StrPtrLen *GetLocalSDP()
	{ return &fLocalSDP; }

	StrPtrLen *GetSourceID()
	{ return &fSourceID; }

	StrPtrLen *GetStreamName()
	{ return &fSessionName; }
	...
	bool HasVideoKeyFrameUpdate()
	{ return fHasVideoKeyFrameUpdate; }
	...
	QTSS_ClientSessionObject GetBroadcasterSession()
	{ return fBroadcasterSession; }

	// For the QTSSSplitterModule, this object can cache a QTSS_StreamRef
	void SetSocketStream(QTSS_StreamRef inStream)
	{ fSocketStream = inStream; }

	QTSS_StreamRef GetSocketStream()
	{ return fSocketStream; }
	...
	SInt64 GetInitTimeMS()
	{ return fInitTimeMS; }

	SInt64 GetNoneOutputStartTimeMS()
	{ return fNoneOutputStartTimeMS; }
