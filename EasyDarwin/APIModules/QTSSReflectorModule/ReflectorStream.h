...
public:
    ...
    OSQueueElem *SendPacketsToOutput(ReflectorOutput *theOutput, OSQueueElem *currentPacket,
...
public:
    ...
    QTSS_Error BindSockets(QTSS_StandardRTSP_Params *inParams, UInt32 inReflectorSessionFlags, bool filterState,
                           UInt32 timeout);
