...
DoSessionSetup(QTSS_StandardRTSP_Params *inParams, QTSS_AttributeID inPathType, bool isPush = false,
...
QTSS_Error Register(QTSS_Register_Params *inParams)
{
    ...
    (void) QTSS_AddStaticAttribute(qtssTextMessagesObjectType, sDuplicateBroadcastStreamName, NULL,
    ...
    (void) QTSS_AddStaticAttribute(qtssTextMessagesObjectType, sAnnounceRequiresSDPinName, NULL,
                                   qtssAttrDataTypeCharArray);
    ...
    (void) QTSS_AddStaticAttribute(qtssTextMessagesObjectType, sExpectedDigitFilenameName, NULL,
                                   qtssAttrDataTypeCharArray);
    (void) QTSS_IDForAttr(qtssTextMessagesObjectType, sExpectedDigitFilenameName, &sExpectedDigitFilenameErr);

    (void) QTSS_AddStaticAttribute(qtssTextMessagesObjectType, sReflectorBadTrackIDErrName, NULL,
                                   qtssAttrDataTypeCharArray);
    ...
    (void) QTSS_AddStaticAttribute(qtssTextMessagesObjectType, sSDPcontainsInvalidMinumumPortErrName, NULL,
                                   qtssAttrDataTypeCharArray);
    (void) QTSS_IDForAttr(qtssTextMessagesObjectType, sSDPcontainsInvalidMinumumPortErrName,
                          &sSDPcontainsInvalidMinimumPortErr);

    static char *sSDPcontainsInvalidMaximumPortErrName = "QTSSReflectorModuleSDPPortMaximumPort";
    (void) QTSS_AddStaticAttribute(qtssTextMessagesObjectType, sSDPcontainsInvalidMaximumPortErrName, NULL,
                                   qtssAttrDataTypeCharArray);
    (void) QTSS_IDForAttr(qtssTextMessagesObjectType, sSDPcontainsInvalidMaximumPortErrName,
                          &sSDPcontainsInvalidMaximumPortErr);

    static char *sStaticPortsConflictErrName = "QTSSReflectorModuleStaticPortsConflict";
    (void) QTSS_AddStaticAttribute(qtssTextMessagesObjectType, sStaticPortsConflictErrName, NULL,
                                   qtssAttrDataTypeCharArray);
    ...
    (void) QTSS_AddStaticAttribute(qtssTextMessagesObjectType, sInvalidPortRangeErrName, NULL,
                                   qtssAttrDataTypeCharArray);
    ...
    (void) QTSS_AddStaticAttribute(qtssClientSessionObjectType, sBroadcasterSessionName, NULL,
    ...
    (void) QTSS_AddStaticAttribute(qtssRTSPSessionObjectType, sBroadcasterSessionName, NULL,
                                   qtssAttrDataTypeVoidPointer);
...
void SetMoviesRelativeDir()
{
    ...
    if (redirectPath.GetBytesWritten() > 0 &&
        kPathDelimiterChar != redirectPath.GetBufPtr()[redirectPath.GetBytesWritten() - 1])
...
QTSS_Error RereadPrefs()
{
    ...
    QTSSModuleUtils::GetAttribute(sPrefs, "enable_broadcast_push", qtssAttrDataTypeBool16,
                                  &sBroadcastPushEnabled, &sDefaultBroadcastPushEnabled,
    ...
    QTSSModuleUtils::GetAttribute(sPrefs, "max_broadcast_announce_duration_secs", qtssAttrDataTypeUInt32,
                                  &sMaxBroadcastAnnounceDuration, &sDefaultMaxBroadcastAnnounceDuration,
    ...
    QTSSModuleUtils::GetAttribute(sPrefs, "enforce_static_sdp_port_range", qtssAttrDataTypeBool16,
                                  &sEnforceStaticSDPPortRange, &sDefaultEnforceStaticSDPPortRange,
    ...
    QTSSModuleUtils::GetAttribute(sPrefs, "maximum_static_sdp_port", qtssAttrDataTypeUInt16,
                                  &sMaximumStaticSDPPort, &sDefaultMaximumStaticSDPPort,
    ...
    QTSSModuleUtils::GetAttribute(sPrefs, "kill_clients_when_broadcast_stops", qtssAttrDataTypeBool16,
                                  &sTearDownClientsOnDisconnect, &sDefaultTearDownClientsOnDisconnect,
    ...
    QTSSModuleUtils::GetAttribute(sPrefs, "timeout_broadcaster_session_secs", qtssAttrDataTypeUInt32,
                                  &sBroadcasterSessionTimeoutSecs, &sDefaultBroadcasterSessionTimeoutSecs,
    ...
    QTSSModuleUtils::GetAttribute(sPrefs, "authenticate_local_broadcast", qtssAttrDataTypeBool16,
                                  &sAuthenticateLocalBroadcast, &sDefaultAuthenticateLocalBroadcast,
    ...
    QTSSModuleUtils::GetAttribute(sPrefs, "disable_overbuffering", qtssAttrDataTypeBool16,
                                  &sDisableOverbuffering, &sDefaultDisableOverbuffering,
    ...
    QTSSModuleUtils::GetAttribute(sPrefs, "enable_play_response_range_header", qtssAttrDataTypeBool16,
                                  &sPlayResponseRangeHeader, &sDefaultPlayResponseRangeHeader,
    ...
    QTSSModuleUtils::GetAttribute(sPrefs, "enable_player_compatibility", qtssAttrDataTypeBool16,
                                  &sPlayerCompatibility, &sDefaultPlayerCompatibility,
    ...
    QTSSModuleUtils::GetAttribute(sPrefs, "compatibility_adjust_sdp_media_bandwidth_percent", qtssAttrDataTypeUInt32,
                                  &sAdjustMediaBandwidthPercent, &sAdjustMediaBandwidthPercentDefault,
    ...
    QTSSModuleUtils::GetAttribute(sPrefs, "force_rtp_info_sequence_and_time", qtssAttrDataTypeBool16,
                                  &sForceRTPInfoSeqAndTime, &sDefaultForceRTPInfoSeqAndTime,
    ...
    char *tempKeyWord = QTSSModuleUtils::GetStringAttribute(sPrefs, "redirect_broadcast_keyword",
    ...
    delete[] sBroadcastsRedirectDir;
    sBroadcastsRedirectDir = QTSSModuleUtils::GetStringAttribute(sPrefs, "redirect_broadcasts_dir",
...
void DoAnnounceAddRequiredSDPLines(QTSS_StandardRTSP_Params *inParams, ResizeableStringFormatter *editedSDP,
                                   char *theSDPPtr)
{
...
QTSS_Error DoAnnounce(QTSS_StandardRTSP_Params *inParams)
{
    ...
    QTSS_Error theErr = QTSS_GetValuePtr(inParams->inRTSPRequest, qtssRTSPReqContentLen, 0, (void **) &theContentLenP,
                                         &theLen);
    ...
    if (theErr != QTSS_NoErr) {
        ...
        theLen = sizeof(theRequestBody);
        theErr = QTSS_SetValue(inParams->inRTSPRequest, sRequestBodyAttr, 0, &theRequestBody,
    ...
    theErr = QTSS_Read(inParams->inRTSPRequest, theRequestBody + theBufferOffset, *theContentLenP - theBufferOffset,
                       &theLen);
...
QTSS_Error DoDescribe(QTSS_StandardRTSP_Params *inParams)
{
    ...
    if (sPlayerCompatibility)
        adjustMediaBandwidth = QTSSModuleUtils::HavePlayerProfile(sServerPrefs, inParams,
    ...
    if (sEnforceStaticSDPPortRange) {
        for (UInt32 x = 0; x < theInfo->GetNumStreams(); x++) {
            ...
            if (theErrorMessageID != qtssIllegalAttrID) {
                ...
                (void) QTSSModuleUtils::SendErrorResponse(inParams->inRTSPRequest, qtssUnsupportedMediaType,
                                                          theErrorMessageID, &thePortStr);
...
void DeleteReflectorPushSession(QTSS_StandardRTSP_Params *inParams, ReflectorSession *theSession, bool foundSession)
{
    ...
    QTSS_Error theErr = QTSS_SetValue(inParams->inClientSession, sClientBroadcastSessionAttr, 0, &stopSessionProcessing,
                        ...
                        QTSS_RTPStreamObject *newStreamPtr)
{
    ...
    // do overbuffering.
    QTSS_Error theErr = QTSS_AddRTPStream(inParams->inClientSession, inParams->inRTSPRequest, newStreamPtr,
...
QTSS_Error DoSetup(QTSS_StandardRTSP_Params *inParams)
{
    ...
    if (theLen != sizeof(RTPSessionOutput *)) {
        ...
        if (theErr != QTSS_NoErr && !isPush) {
            ...
            (void) QTSS_SetValue(inParams->inClientSession, qtssCliSesTimeoutMsec, 0,
    ...
    if (isPush) {
        ...
        theErr = QTSS_SetValue(inParams->inRTSPRequest, qtssRTSPReqSetUpServerPort, 0, &theReceiveBroadcastStreamPort,
    ...
    Assert(theErr == QTSS_NoErr);
    theErr = QTSS_SetValue(newStream, qtssRTPStrTimescale, 0, &theStreamInfo->fTimeScale,
...
bool HaveStreamBuffers(QTSS_StandardRTSP_Params *inParams, ReflectorSession *inSession)
{
    ...
    for (theStreamIndex = 0;
         QTSS_GetValuePtr(inParams->inClientSession, qtssCliSesStreamObjects, theStreamIndex, (void **) &theRef,
                          &theLen) == QTSS_NoErr;
         theStreamIndex++) {
...
QTSS_Error DoPlay(QTSS_StandardRTSP_Params *inParams, ReflectorSession *inSession)
{
    ...
    if (inSession == NULL)    // 推送端
    {
        ...
        theErr = QTSS_SetValue(inParams->inClientSession, sKillClientsEnabledAttr, 0, &sTearDownClientsOnDisconnect,
        ...
        (void) QTSS_SetValue(inParams->inClientSession, qtssCliSesMovieAverageBitRate, 0, &bitsPerSecond,
                             sizeof(bitsPerSecond));

        if (sPlayResponseRangeHeader) {
            StrPtrLen temp;
            theErr = QTSS_GetValuePtr(inParams->inClientSession, sRTPInfoWaitTimeAttr, 0, (void **) &temp.Ptr,
                                      &temp.Len);
            if (theErr != QTSS_NoErr)
                QTSS_AppendRTSPHeader(inParams->inRTSPRequest, qtssRangeHeader, sTheNowRangeHeader.Ptr,
                                      sTheNowRangeHeader.Len);
        }

        if (sPlayerCompatibility)
            rtpInfoEnabled = QTSSModuleUtils::HavePlayerProfile(sServerPrefs, inParams,
        ...
        if (rtpInfoEnabled) {
            ...
            if (haveBufferedStreams) // send the cached rtp time and seq number in the response.
            {
                ...
                if (theErr != QTSS_NoErr)
                    (void) QTSS_SetValue(inParams->inClientSession, sRTPInfoWaitTimeAttr, 0, &sWaitTimeLoopCount,
                    ...
                    if (waitTimeLoopCount < 1)
                        return QTSSModuleUtils::SendErrorResponseWithMessage(inParams->inRTSPRequest,
                                                                             qtssClientNotFound, &sBroadcastNotActive);

                    waitTimeLoopCount--;
                    (void) QTSS_SetValue(inParams->inClientSession, sRTPInfoWaitTimeAttr, 0, &waitTimeLoopCount,
...
QTSS_Error DestroySession(QTSS_ClientSessionClosing_Params *inParams)
{
    ...
    if (theSession != NULL)    // 推送端
    {
        ...
        theErr = QTSS_SetValue(inParams->inClientSession, sClientBroadcastSessionAttr, 0, &deletedSession,
...
bool AcceptSession(QTSS_StandardRTSP_Params *inParams)
{
    ...
    if (QTSSModuleUtils::UserInGroup(QTSSModuleUtils::GetUserProfileObject(theRTSPRequest), sBroadcasterGroup.Ptr,
    ...
    QTSS_Error err = QTSS_GetValue(inRTSPSession, qtssRTSPSesRemoteAddrStr, 0, (void *) theClientIPAddressStr.Ptr,
...
QTSS_Error ReflectorAuthorizeRTSPRequest(QTSS_StandardRTSP_Params *inParams)
{
    ...
    accessFile.AuthorizeRequest(inParams, allowNoAccessFiles, noAction, authorizeAction, &outAuthorized,
                                &outAllowAnyUser);
...
QTSS_Error RedirectBroadcast(QTSS_StandardRTSP_Params *inParams)
{
    ...
    if ((sRedirectBroadcastsKeyword && sRedirectBroadcastsKeyword[0] != 0)
        ...
        (void) QTSS_SetValue(theRequest, qtssRTSPReqRootDir, 0, sBroadcastsRedirectDir,
        ...
        (void) QTSS_SetValue(theRequest, qtssRTSPReqFilePath, 0, theStrippedRequestPath.Ptr,
